...
public class _CommunicationStub extends org.omg.CORBA.portable.ObjectImpl implements dessine_module.Communication
{
  ...
  public String pushImage (dessine_module.Image image, dessine_module.HostInfo producerInfo) throws dessine_module.Reject
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("pushImage", true);
                ...
                return pushImage (image, producerInfo        );
            } finally {
                _releaseReply ($in);
            }
  } // pushImage
  ...
  public void readyForPull (String ticket, dessine_module.HostInfo producerInfo)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                readyForPull (ticket, producerInfo        );
            } finally {
                _releaseReply ($in);
            }
  } // readyForPull
